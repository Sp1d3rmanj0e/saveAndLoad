...
topTimeCompleted = [
					...
					["EXAMPLE NAME 01", 12.12],["HEH",5940.00]],
...
topSenseUseTime  = [
					...
					["EXAMPLE NAME 01", 11.12],["HEH",1111]],
	...
	for (var i = 0; i < _length; i++)
	{
		...
		else // Last 6 panels
		{
			draw_panel(paddingH + scorePadding + _panelWidth, 
						(paddingV + buttonHeight * 2) + _panelHeight * (i - 6) + scorePadding/2,
						_panelWidth, _panelHeight - scorePadding, i+1, _array[i]);
		}
	}
